...
function initPositions() {
  setupPostTask(window, function (res) {
    ...
    if (res) {
      ...
      var bottom = 0
      setXY(ZONE_TYPE.QRCODE, 0, Num > 1 ? (PageSize.W / Num - 40) : (PageSize.W - PageMargins.Right - 20), PageMargins.Top)
      ...
      setXY(ZONE_TYPE.THER_EVALUATION, res.pageNum - 1, evaluationX, PageSize.H - PageMargins.Bottom - bottom)
      setXY(ZONE_TYPE.PASS, res.pageNum - 1, evaluationX + 150, PageSize.H - PageMargins.Bottom - bottom)
      setXY(ZONE_TYPE.IGNORE, res.pageNum - 1, PageSize.W - 15 - ZONE_SIZE[ZONE_TYPE.IGNORE].w, PageSize.H - PageMargins.Bottom - bottom)
      if (res.hasHeader) {
