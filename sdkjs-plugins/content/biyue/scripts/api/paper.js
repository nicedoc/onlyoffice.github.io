 ...
 */
function examImportQuestionBank({exam_title, subject_code, subject_value, grade_code, page_num, ques_num, exam_score, ref_id,
  print_paper_type, paper_num, for_mask, exam_begin, exam_end, participants_num, is_for_grade, is_update, exam_type, scope_id, light_code}) {
  return authRequest({
