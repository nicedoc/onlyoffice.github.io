(function (window, undefined) {
  ...
  function addType(zone_type, name, x, y, w, h) {
  ...
  function onBtnClick(e) {
    ...
    if (id == 'cancel') {
      ...
      window.Asc.plugin.sendToPlugin("onWindowMessage", {type: 'confirmDialog', data: {}});
    } else {
      var strs = id.split('_')
  ...
  function init() {
    ...
    addType(ZONE_TYPE.END, '完成', 29, 20, 20, 10)
    addType(ZONE_TYPE.STATISTICS, '统计', 29, 20, 20, 10)
